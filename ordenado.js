...
if (currentUrl == "/VerSupervisor") {
  ...
  const formularioSup = document.getElementById('AgregarSupervisor');
...
if ((currentUrl == "/VerPracticantes") || (currentUrl == "/VerPracticantesSupervisor")) {
  console.log('Prac');
...
if (currentUrl == "/agregarPracticante") {
  ...
  const formularioPrac = document.getElementById('agregarPacticante');

  formularioPrac.addEventListener('submit', function (event) {
    event.preventDefault(); // Evita que se realice el submit por defecto del formulario
  });
...
if (currentUrl == "/AgendarCita") {
  ...
  // ---------------------------- Hora ---------------------------- //
  const timeInput = document.getElementById('timeCita');
  ...
  // --------------------------- End Modal agenda cita paciente --------------------------- //
}
